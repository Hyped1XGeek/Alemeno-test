...
def main():
    ...
    if credit_score > 50:
        print("     - Should approve any interest rate")
    elif credit_score > 30:
        print("     - Should approve only if interest rate > 12%")
    elif credit_score > 10:
        print("     - Should approve only if interest rate > 16%")
    else:
        print("     - Should reject all loans")
