...
def main():
    ...
    try:
        ...
        print("\n🌐 API Endpoint:")
        print("   GET http://127.0.0.1:8000/api/credit-score/316/")
    ...
    print("   GET http://127.0.0.1:8000/api/credit-score/99999/")
    print("   Expected: 404 Not Found")

    print("\n✅ Credit Score API endpoint is ready!")
    print("   Endpoint: GET /api/credit-score/<customer_id>/")
    print("   Returns: Customer details and credit score")
