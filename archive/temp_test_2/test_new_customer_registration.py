...
from credit_system.services.customer_management import CustomerManagementService
...
def main():
    ...
    print(f"📊 Testing Approved Limit Calculation for New Customers:")
    ...
    print(f"   For a customer with ₹8,000 monthly income:")
    print(f"   POST /api/register/")
    print(f"   Body: {{'monthly_income': '8000', ...}}")
    print(f"   Expected Response: {{'approved_limit': 300000.0, ...}}")
